 ...
 * by using a wrapper form ({@link BusinessValueFormAsWrapper}). The wrapper form defines all
 * validations for validating the input parameters.<br/>
 * <br/>
 * This test tests the rootBinding option. This allows to bind a property like "businessValue1.numberOne"
 * by using the parameter "numberOne" (the properties of the given beans are directly bound to the action).<br/>
 * <br/>
 * @author Olaf Stracke
 */
@UrlBinding("/test/ValidationFormFormAsValueWrapperRootBindingTest.action")
public class ValidationFormFormAsValueWrapperRootBindingTest extends FilterEnabledTestBase implements ActionBean {
   ...
   @ValidateForm(on = "eventOne", rootBinding = true)
   ...
   public void testEventOneAsDefault() throws Exception {
      ...
      ValidationFormFormAsValueWrapperRootBindingTest test = trip.getActionBean(getClass());
