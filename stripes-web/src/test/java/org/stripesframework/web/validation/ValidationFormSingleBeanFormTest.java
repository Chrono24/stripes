 ...
 * @author Olaf Stracke
 */
@UrlBinding("/test/ValidationFormSingleBeanFormTest.action")
public class ValidationFormSingleBeanFormTest extends FilterEnabledTestBase implements ActionBean {
   ...
   @ValidateForm(form = BusinessValueForm.class, on = "eventOne")
   ...
   public void testEventOneAsDefault() throws Exception {
      ...
      ValidationFormSingleBeanFormTest test = trip.getActionBean(getClass());
